...
as $20260126101329_add_get_entitlements_v2$
  select
    tm.tenant_id,
    t.workspace_name,
    tm.role,
...
$20260126101329_add_get_entitlements_v2$;

grant execute on function public.get_entitlements_v2() to authenticated;

do $20260126101329_add_get_entitlements_v2$
begin

exception when others then
  null;
end $20260126101329_add_get_entitlements_v2$;
